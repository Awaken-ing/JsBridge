...
public class ParameterType {
    ...
    public static final int TYPE_FOJ = 34;
    public static final int TYPE_OOJ = 35;
    public static final int TYPE_IOJ = 36;
            ...
            switch (parameters.length) {
                ...
                case 3:
                    if (Utils.classIsRelative(parameters[0], Activity.class) && Utils.classIsRelative(parameters[1], String.class) && Utils.classIsRelative(parameters[2], JSCallback.class)) {
                        return TYPE_AOJ;
                    }if (Utils.classIsRelative(parameters[0], Fragment.class) && Utils.classIsRelative(parameters[1], String.class) && Utils.classIsRelative(parameters[2], JSCallback.class)) {
                        return TYPE_FOJ;
                        ...
                        return TYPE_AWO;
                    }else if (Utils.classIsRelative(parameters[0], Object.class) && Utils.classIsRelative(parameters[1], String.class) && Utils.classIsRelative(parameters[2], JSCallback.class)){
                    return TYPE_OOJ;
                }
                    break;
                case 4:
